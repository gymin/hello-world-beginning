...
# Plot matrices (each row and column represents a different variable, and a subplot against those variables generated in each plot matrix cell 
...
### but if we want to look at the relationship between the numeric and categorical variables in the data, 
